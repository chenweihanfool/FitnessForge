...
- **Muscle Group Percentage Tracking**: Each exercise can specify percentage contributions to 8 muscle groups (胸/背/腿/肩/手臂/核心/臀/全身). Percentages range 0-100 and can sum to more than 100% for compound movements. Dashboard displays weekly muscle group training volume calculated proportionally from entries.
