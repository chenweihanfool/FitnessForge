...
- **Custom Exercise Management**: Users can define custom exercise types with units, weight factors, and categories (strength, cardio, flexibility, core, balance, activity).
