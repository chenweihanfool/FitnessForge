...
- **Five-Stage Milestone System**: Weekly performance is evaluated through a sequential milestone system: Stage 1 (Top 70%), Stage 2 (Total above average), Stage 3 (Three categories above average), Stage 4 (Top 10%), Stage 5 (Full Achievement = all exercises with historical data above their average AND all muscle groups with training records ≥4 sets for maintenance). Milestones must be achieved in order; stars are displayed on the dashboard to indicate achieved stages.
